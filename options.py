...
# 1-rgb images, 2-thermal images, 3-audio
# 4-rgb and thermal images, 5-rgb and audio, 6-thermal and audio, 7-all
mode = 7
...
rnoise_value = 100       # 'gauss' -> SNR, 'blur' -> kernel size

add_thr_noise = False
thr_noise = 'gauss'     # 'gauss', 
tnoise_value = 100       # 'gauss' -> SNR
